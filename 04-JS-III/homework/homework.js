...
/*   var str = palabras[0];
  ...
  return palabras.join(' '); //MÉTODO FÁCIL
}
...
/*   for(var i = 0; i < array.length; i++) {
  ...
  return false;*/
  return array.includes(elemento); //MÉTODO FÁCIL
} 
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  //TENEMOS QUE CONVERTIR EL NÚMERO QUE RECIBIMOS EN UN STRING
  var aux = n.toString();
  //'hola' => ['h','o','l','a']
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  var comparacion = arreglo [0]; //capturo el primer elemento
